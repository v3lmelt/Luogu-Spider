...
class TagGetter:
    def __init__(self):
        ...
        self.path = "F:/json_mapper/mapper.json"

    def tag_weblink_generator(self, tag_id):
        return "https://www.luogu.com.cn/problem/list?tag=" + str(tag_id)
    ...
    def tag_getter(self, tag_id):
        ...
        try:
            ...
            try:
                t = driver.find_element(By.XPATH, "/html/body/div/div[2]/main/div/section/div/section[3]/div/div[2]")
            except selenium.common.exceptions.NoSuchElementException:
                print(f"tag_id: {tag_id} , 该网页获取的不是Tag信息!")
            else:
...
if __name__ == '__main__':
    ...
    tag_getter.tag_getter_worker(6)